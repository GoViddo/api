module.exports = {
    ...
    sendEmail: (req, res) => {
        ...
        var body = '<div id=":16h" class="ii gt"><div id=":16g" class="a3s aXjCH "><div class="adM">' +
            ...
            '<td align="center" height="150" valign="middle" width="300"><a href="https://goviddo.com" target="_blank" ><img alt="GoViddo" height="128" src="https://goviddo.com/app/images/LogoGoV.svg" width="278" class="CToWUd"></a></td>' +
