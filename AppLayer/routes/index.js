                        ...
                        return new Promise(function (resolve, reject) {
                            cmd.get(
                                ...
                                function (err, data, stderr) {
                                    ...
                                    let createEOSWalletCommand = "cleos -u https://eos.greymass.com/ system newaccount hellogoviddo " + walletName + " --stake-net '0.01 EOS' --stake-cpu '0.01 EOS' --buy-ram '0.3 EOS' " + ownerPublicKey + " " + resp.activePublicKey;
